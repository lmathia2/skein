...
from harness.core.config import DEFAULT_COMPOSITION_PATH, SkeinConfig
...
from harness.execution.repo import RepositoryManifest, repository_manifest_from_snapshot
from harness.execution.sandbox import CommandSandbox, SandboxRequest, SandboxResult
from harness.execution.sandbox.output import bounded_result, environment_secret_values
...
class HarborWorkspaceEnvironment:
    ...
    def atomic_write(
        ...
        *,
        ...
        from harness.execution.environment.local import _text_diff
