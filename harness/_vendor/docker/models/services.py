...
from harness._vendor.docker.errors import InvalidArgument, create_unexpected_kwargs_error
from harness._vendor.docker.types import ContainerSpec, Placement, ServiceMode, TaskTemplate
