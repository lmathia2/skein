...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("npm run --workspace happy-dom test -- --run test/observer.test.ts", True),
        ("npm run --workspace=happy-dom test", True),
        ("npm run --workspace happy-dom build", False),
        ("npm run --workspace happy-dom test:deploy", False),
        ("pnpm -F core test run tests/aspect.test.ts", True),
        ("pnpm --filter core test", True),
        ("rg -n TODO src", False),
